...
/**
 * Helper class to execute sql commands
 */
public class DBExecutor extends SQLiteOpenHelper {
    ...
    private static final String SQL_CREATE_USER =
            "CREATE TABLE " + UserDB.TABLE_NAME + " (" +
                    UserDB.COLUMN_NAME_USER_ID + INTEGER_TYPE + COMMA_SEP +
    ...
    private static final String SQL_CREATE_PITCH =
            "CREATE TABLE " + PitchDB.TABLE_NAME + " (" +
                    PitchDB.COLUMN_NAME_PITCH_ID + INTEGER_TYPE + COMMA_SEP +
    ...
    private static final String SQL_CREATE_CHAT =
            "CREATE TABLE " + ChatDB.TABLE_NAME + " (" +
                    ...
                    " FOREIGN KEY (" +
                    ChatDB.COLUMN_NAME_AUTHOR + REFERENCES + UserDB.TABLE_NAME + "(" + UserDB.COLUMN_NAME_USER_ID + ")" +
                    ChatDB.COLUMN_NAME_PID + REFERENCES + PitchDB.TABLE_NAME + "(" + PitchDB.COLUMN_NAME_PITCH_ID + ")" +
                    "))";
